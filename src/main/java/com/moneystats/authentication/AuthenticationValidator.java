...
import com.moneystats.MoneyStats.statement.StatementValidator;
...
public class AuthenticationValidator {
    ...
    public static void validateAuthCredentialDTO(AuthCredentialDTO authCredentialDTO) throws AuthenticationException {
        ...
        if (!violations.isEmpty()) {
            ...
            throw new AuthenticationException(AuthenticationException.Type.INVALID_AUTH_CREDENTIAL_DTO);
        }
    }

    public static void validateAuthCredentialInputDTO(AuthCredentialInputDTO authCredentialInputDTO) throws AuthenticationException {
        ValidatorFactory factory = Validation.buildDefaultValidatorFactory();
        Validator validator = factory.getValidator();
        ...
        if (!violations.isEmpty()) {
            ...
            throw new AuthenticationException(AuthenticationException.Type.INVALID_AUTH_INPUT_DTO);
        }
    }
}
