...
public class StatementEntity {
	...
	public StatementEntity(int id, String date, Double value, AuthCredentialEntity user, WalletEntity wallet) {
		this.id = id;
		this.date = date;
		this.value = value;
		this.user = user;
	...
	public StatementEntity(String date, Double value, AuthCredentialEntity user, WalletEntity wallet) {
		this.date = date;
		this.value = value;
		this.user = user;
		this.wallet = wallet;
